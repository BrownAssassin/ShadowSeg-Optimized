"""DeepLabV3+ R50 training config for RoverShadow."""
...
default_hooks = dict(
    checkpoint=dict(type="CheckpointHook", by_epoch=False, interval=1000, max_keep_ckpts=12),
    logger=dict(type="LoggerHook", interval=50, log_metric_by_epoch=False),
)

randomness = dict(seed=42, deterministic=False)
work_dir = "work_dirs/shadow_deeplabv3plus_r50"
